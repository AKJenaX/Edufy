      ...
      <div className="card bg-slate-900/40 border border-white/5 shadow-2xl p-2 sm:p-2.5">
        ...
        {activeTab === 'timetable' && (
          <div className="mt-8 max-w-xl mx-auto space-y-6">
            ...
            {generatedTimetable && (
              <div className="mt-6 p-5 bg-white/[0.02] border border-white/5 rounded-2xl backdrop-blur-md">
                <h4 className="font-bold text-white text-sm mb-3">Generated Timetable</h4>
                <pre className="text-xs text-indigo-300 overflow-auto bg-slate-950/80 p-4 rounded-xl border border-white/5 font-mono">
